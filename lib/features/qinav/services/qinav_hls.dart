...
/// Rewrite any playlist so all media URLs point at the local proxy with absolute URLs.
...
String rewriteMedia(String text, String baseUrl, String proxyBase) {
  ...
  for (final line in text.split(RegExp(r'\r?\n'))) {
    ...
    if (t.startsWith('#EXT-X-KEY')) {
      // METHOD=NONE is non-standard and breaks ExoPlayer on some devices.
...
/// Pick highest-bandwidth variant URL from a master playlist, or null.
